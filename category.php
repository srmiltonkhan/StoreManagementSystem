            ...
            <div class="container-fluid">
              ...
              <!-- Table Section -->
               <div class="row border">
                <div class="col p-1" >Category List</div>
                <div class="col p-1" align="right">
                  <button class="btn btn-primary btn-sm launch-modal" data-toggle="modal" data-target="#category_modal" id="add_button"><i class="fas fa-plus-square"></i> Add Category</button>
                </div>
               </div>
            ...
            <div class="modal fade" id="category_modal">
              <div class="modal-dialog modal-lg">
                <div class="modal-content">
                        <form method="post" id="category_form" name="category_form" novalidate>
